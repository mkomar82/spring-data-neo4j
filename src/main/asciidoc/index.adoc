...
Michael Hunger; Oliver Gierke; Vince Bickers; Adam George; Luanne Misquitta; Michal Bachman; Mark Angrish; Jasper Blues
:toc:
:toc-placement!:
:revnumber: {version}
:revdate: {localdate}

Spring Data Neo4j Version 4.2 (December 2016)
